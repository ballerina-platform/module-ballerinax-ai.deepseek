...
class GenerateMethodModificationTask implements ModifierTask<SourceModifierContext> {
    ...
    public GenerateMethodModificationTask(AiDeepseekCodeModifier.AnalysisData analysisData) {
    ...
    private class GenerateMethodVisitor extends NodeVisitor {
        ...
        private static final String DEEPSEEK_MODEL_PROVIDER_NAME = "Provider";
        private static final String DEEPSEEK_MODEL_PROVIDER_MODULE_NAME = "ai.model.provider.deepseek";
        ...
        public void visit(RemoteMethodCallActionNode remoteMethodCallActionNode) {
            ...
            semanticModel.typeOf(expression).ifPresent(expressionTypeSymbol ->
                    getDeepseekModelProviderSymbol(remoteMethodCallActionNode).ifPresent(moduleSymbol ->
        ...
        private Optional<ModuleSymbol> getDeepseekModelProviderSymbol(Node node) {
